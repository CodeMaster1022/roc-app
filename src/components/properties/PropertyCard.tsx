        ...
        <div className="space-y-3">
          ...
          <div className="flex justify-between items-start">
            ...
            <div className="text-right shrink-0">
              ...
              <p className="text-xs text-muted-foreground">{t('units.month')}</p>
            </div>
          </div>

          {/* Información básica con iconos específicos */}
          <div className="grid grid-cols-2 gap-3 text-sm text-muted-foreground min-h-[80px]">
          ...
          >
            {isAvailable ? t('property.view_more') : 'No disponible'}
          </RocButton>
        </div>
      </CardContent>
    </Card>
